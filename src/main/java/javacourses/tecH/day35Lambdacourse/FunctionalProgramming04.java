...
public class FunctionalProgramming04 {
	...
	public static void getSumOfAllElements(List<Integer> l) {		
		...
		//In functional programming some methods like reduce() must be the last method, 
		//that kind of methods are called "terminal methods"
	}
	...
	//2)Create a method to find the sum of integers from 7 to 100
		...
		public static void getSumOfIntFrom7To100A() {
			...
			//IntStream ==> Give you directly Integer stream. No collection or list
			//IntStream.range(Inclusive, NotInclusive) ==> all integer stream have to have a range
			//IntStream.rangeClosed(startInclusive, endInclusive) ==> It is better to use. Because 
