package javacourses.tecH.day03increment_decrement_operators;
...
public class ModulusOperator01 {
	...
	public static void main(String[] args) {
		...
		/*
		 	Modulus operator(%) is used to find the remainder when you divide a number by the other.
		 	25:4 ==> The remainder will be 1.
		*/
